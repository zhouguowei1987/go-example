...
func main() {
	...
	for {
		...
		curPage++
		for i := 1; i <= NextPageSleep; i++ {
			time.Sleep(time.Second)
			fmt.Println("===========翻", curPage, "页，暂停", NextPageSleep, "秒，倒计时", i, "秒===========")
		}
	}
}
