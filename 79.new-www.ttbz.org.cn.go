...
func main() {
	...
	for id := startId; id <= endId; id++ {
		...
		filePath := "../www.ttbz.org.cn/water-marked-www.ttbz.org.cn/" + title + "(" + code + ").pdf"
		...
		//复制文件
		tempFilePath := strings.ReplaceAll(filePath, "www.ttbz.org.cn/water-marked-www.ttbz.org.cn", "www.ttbz.org.cn/temp-www.ttbz.org.cn")
