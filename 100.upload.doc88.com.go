...
func main() {
	...
	for _, childDir := range uploadChildDirArr {
		...
		for _, file := range files {
			...
			// 设置倒计时
			UploadDoc88TimeSleep := rand.Intn(20)
            if UploadDoc88TimeSleep <= 10{
                UploadDoc88TimeSleep = 10 + rand.Intn(5)
            }
