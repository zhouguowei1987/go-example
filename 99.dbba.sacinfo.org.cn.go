...
const DbBaCookie = "HMACCOUNT=487EF362690A1D5D; Hm_lvt_36f2f0446e1c2cda8410befc24743a9b=1751852258; Hm_lpvt_36f2f0446e1c2cda8410befc24743a9b=1753165988; JSESSIONID=65043ABB2D7358AE2EE455102C4536FF"
			...
			for _, records := range responseData.Records {
				if records.Empty == false {
					...
					ValidateCaptchaGoTo:
						...
						err = DbBaCopyDbBaFile(filePath, tempFilePath)
						if err != nil {
							fmt.Println(err)
							continue
						}
...
func DbBaCopyDbBaFile(src, dst string) (err error) {
	in, err := os.Open(src)
	if err != nil {
		return
	}
