...
const DbBaCookie = "HMACCOUNT=487EF362690A1D5D; Hm_lvt_36f2f0446e1c2cda8410befc24743a9b=1751852258; Hm_lpvt_36f2f0446e1c2cda8410befc24743a9b=1754319265; JSESSIONID=397308296343150C3079F3B25BB40837"
...
func validateCaptchaDbBa(captcha string, pk string, referer string) (responseValidateCaptcha HdBaResponseValidateCaptcha, err error) {
	// 初始化客户端
	var client *http.Client = &http.Client{
		Transport: &http.Transport{
			Dial: func(netw, addr string) (net.Conn, error) {
